...
<div id="wrapper">
  ...
  <form name="login-form" class="login-form" action="" method="post">
    ...
    <div class="header">
    <h1>Login Form</h1>
    <span>Fill out your credentials below</span>
    </div>
...
<form name="register" class="login-form" action="register.php" method="post">
    <div class="footer">
...
$con = mysql_connect("localhost","gareth","beasty12");
if (!$con)
{
...
$sql = "INSERT INTO userlist (name, password) VALUE ('$_POST[name]'), ('$_POST[password]'), "; 
